...
async function seed() {
  ...
  await db.insert(pages).values([
    ...
    { title: "Política de Devoluções", slug: "politica-devolucoes", content: "Nas vendas à distância abrangidas pela lei, o consumidor dispõe, em regra, de 14 dias para exercer o direito de livre resolução. Consulte a página publicada para procedimentos, reembolso, custos, estado do artigo e exceções legais.", isPublished: true },
    { title: "Garantias", slug: "garantias", content: "Os consumidores beneficiam dos direitos legais de conformidade previstos no Decreto-Lei n.º 84/2021. A área RMA / Assistência permite iniciar pedidos de pós-venda; garantias comerciais adicionais não reduzem os direitos legais aplicáveis.", isPublished: true },
    ...
    { title: "Sobre Nós", slug: "sobre-nos", content: "A MDTech, nome comercial da Marco Duarte Tech Solutions Unipessoal Lda, é uma empresa sediada em Esposende dedicada à informática, tecnologia, venda de equipamentos, reparação, configuração e assistência técnica a particulares e empresas.", isPublished: true },
  ]).onConflictDoNothing();
